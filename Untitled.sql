...
select * from integrations.demo_events
where value ilike '%Finish executing notebook%' limit 10;
...
ALTER USER NOTEBOOK_USER MODIFY PROGRAMMATIC ACCESS TOKEN NOTEBOOK_USER_TOKEN
